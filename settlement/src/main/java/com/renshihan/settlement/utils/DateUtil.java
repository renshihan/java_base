...
public class DateUtil extends DateUtils {
     ...
     * @return
     */
    public static Date getDate0H0M0S0MS(Calendar calendar) {
        calendar.set(Calendar.HOUR_OF_DAY, 0);
        calendar.set(Calendar.MINUTE, 0);
        calendar.set(Calendar.SECOND, 0);
        calendar.set(Calendar.MILLISECOND, 0);
     ...
     * @return
     */
    public static Date getDate23H59M59S0MS(Calendar calendar) {
        calendar.set(Calendar.HOUR_OF_DAY, 23);
        calendar.set(Calendar.MINUTE, 59);
        calendar.set(Calendar.SECOND, 59);
        calendar.set(Calendar.MILLISECOND, 999);
...
//        System.out.println(LocalDate.now().plusDays(-1));
     ...
     * @return
     */
    public static Date getDateFromZeroMorningHours(Date date,Integer hours,Integer minutes) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
    ...
    public static Integer getDaysCountBetween(Date startTime,Date endTime)throws Exception{
        ...
        Calendar cal = DateUtil.toCalendar(startTime,TimeZone.getTimeZone("GMT+8"));
